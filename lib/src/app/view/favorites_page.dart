...
void _onPhotoClicked(int index, BuildContext context)
{
  Widget okButton = FlatButton(
    child: Text("OK"),
    onPressed: () {
      ImgurTools.favoriteAnImage(vars.Constants.fav[index].iId);
  ...
  AlertDialog alert = AlertDialog(
    title: Text("You don't want me here ? :("),
    content: Text("Would you like to unfavorite this picture ?"),
    actions: [
      okButton,
      notOkButton,
    ],
...
class FavoritesPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Favorites", textAlign: TextAlign.center,),
        actions: <Widget>[
      ...
      child: new GridView.count(
        ...
        mainAxisSpacing: 10,
        crossAxisCount: 2,
        children: _getPhotos(vars.Constants.fav, context),
      ),
    ),
    );
  }
